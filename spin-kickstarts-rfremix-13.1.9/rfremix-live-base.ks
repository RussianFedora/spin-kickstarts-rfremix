...
repo --name=russianfedora --mirrorlist=http://russianfedora.tigro.info/13/.mirrorlist-russianfedora-$basearch --exclude kernel* --exclude generic*
repo --name=russianfedora-updates --mirrorlist=http://russianfedora.tigro.info/13/.mirrorlist-russianfedora-updates-$basearch --exclude=*PAE* --exclude=*PAE* --exclude generic*
#repo --name=russianfedora-updates-testing --mirrorlist=http://russianfedora.tigro.info/13/.mirrorlist-russianfedora-updates-testing-$basearch --exclude=*PAE* --exclude=*PAE* --exclude kernel-kdump* --exclude=*PAE*
repo --name=rpmfusion-free --exclude=akmod*,freetype-freeworld --mirrorlist=http://russianfedora.tigro.info/13/.mirrorlist-rpmfusion-free-$basearch --exclude=*PAE* --exclude=*2.6.33.3-85*
repo --name=rpmfusion-free-updates --exclude=akmod*,freetype-freeworld --mirrorlist=http://russianfedora.tigro.info/13/.mirrorlist-rpmfusion-free-updates-$basearch --exclude=*PAE*
repo --name=rpmfusion-nonfree --exclude=akmod*,*nvidia-96xx* --mirrorlist=http://russianfedora.tigro.info/13/.mirrorlist-rpmfusion-nonfree-$basearch --exclude=*PAE* --exclude=*2.6.33.3-85*
repo --name=rpmfusion-nonfree-updates --exclude=akmod*,*nvidia-96xx* --mirrorlist=http://russianfedora.tigro.info/13/.mirrorlist-rpmfusion-nonfree-updates-$basearch --exclude=*PAE*
repo --name=russianfedora-free --mirrorlist=http://russianfedora.tigro.info/13/.mirrorlist-russianfedora-free-$basearch --exclude=*PAE*
repo --name=russianfedora-free-updates --mirrorlist=http://russianfedora.tigro.info/13/.mirrorlist-russianfedora-free-updates-$basearch --exclude=*PAE*
repo --name=russianfedora-nonfree --mirrorlist=http://russianfedora.tigro.info/13/.mirrorlist-russianfedora-nonfree-$basearch --exclude=*PAE*
repo --name=russianfedora-nonfree-updates --mirrorlist=http://russianfedora.tigro.info/13/.mirrorlist-russianfedora-nonfree-updates-$basearch --exclude=*PAE*
repo --name=russianfedora-fixes --mirrorlist=http://russianfedora.tigro.info/13/.mirrorlist-russianfedora-fixes-$basearch --exclude=*PAE*
repo --name=russianfedora-fixes-updates --mirrorlist=http://russianfedora.tigro.info/13/.mirrorlist-russianfedora-fixes-updates-$basearch --exclude=*PAE*
